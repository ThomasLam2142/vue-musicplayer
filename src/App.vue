...
import { ref } from 'vue';
const songs = ref([
  { name: 'Gods Plan', location: '../music/gods_plan.mp3' },
  { name: 'Life is Good', location: '../music/life_is_good.mp3' },
  { name: 'Sticky', location: '../music/Sticky.mp3' },
  { name: 'Search & Rescue', location: '../music/search_&_rescue.mp3' },
  { name: 'Currents', location: '../music/Currents.mp3' },
]);

const currentSong = ref({
  name: 'Gods Plan',
  location: '../music/gods_plan.mp3'
});
